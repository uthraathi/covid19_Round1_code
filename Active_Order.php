...
//                $MyConnection = mysqli_connect(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_NAME);
                ...
                $sql = "SELECT u.*,s.shop_name,r.user_name FROM user_registration r, user_order u,shop_keeper_registration s where u.SHOP_ID = '$user_id' and  r.user_id = u.user_id and u.ORDER_STATUS = 2 and s.SK_UNIQUE_ID = u.SHOP_ID order by u.ORDER_DATE desc";
